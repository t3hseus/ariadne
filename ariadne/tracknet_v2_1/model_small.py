...
@gin.configurable
class TrackNetClassifierSmall(nn.Module):
    ...
    """
    def __init__(self, gru_size=32, coord_size=2, num_classes=2, num_gru=1):
        super().__init__()
        self.gru_feat_block = nn.Sequential(nn.Linear(gru_size*num_gru, 20),
                                       #nn.BatchNorm1d(30),
                                       nn.ReLU(),
                                       nn.Linear(20, 10)
                                       )
